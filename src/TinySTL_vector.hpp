#ifndef __TINYSTL_VECTOR_HPP
#define __TINYSTL_VECTOR_HPP
#include <cstddef> //for size_t


#include "TinySTL_alloc.h"   //编译需要TinySTL_alloc.cc
...
//总是进入iterator_traits<Iterator>偏特化。故只定义了typedef value_type* iterator;
protected:
...
//	iterator insert (iterator position, int n, const T& val); 
//	iterator insert (iterator position, long n, const T& val); 
